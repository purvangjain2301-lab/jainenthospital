...
const Baby = createLucideIcon("baby", __iconNode$15);
const __iconNode$14 = [
  [
    "path",
    {
...
const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$14);
const __iconNode$13 = [
...
const BedDouble = createLucideIcon("bed-double", __iconNode$13);
const __iconNode$12 = [
...
const CalendarCheck = createLucideIcon("calendar-check", __iconNode$10);
const __iconNode$$ = [
...
const Ear = createLucideIcon("ear", __iconNode$P);
const __iconNode$O = [
