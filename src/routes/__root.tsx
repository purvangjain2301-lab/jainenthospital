...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ENT and Head & Neck Cancer specialist care in Deesa, Gujarat. 17+ years experience. Mon–Sat 10 AM–7 PM. 24×7 Emergency. Call +91 93257 69599." },
      { name: "author", content: "Jain ENT Hospital" },
      { property: "og:site_name", content: "Jain ENT Hospital" },
      { property: "og:title", content: "Jain ENT Hospital, Deesa — Prof. Dr. Devendra M. Jain" },
      { property: "og:description", content: "ENT and Head & Neck Cancer specialist care in Deesa, Gujarat. 17+ years experience. Mon–Sat 10 AM–7 PM. 24×7 Emergency. Call +91 93257 69599." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1A237E" },
      { name: "twitter:title", content: "Jain ENT Hospital, Deesa — Prof. Dr. Devendra M. Jain" },
      { name: "twitter:description", content: "ENT and Head & Neck Cancer specialist care in Deesa, Gujarat. 17+ years experience. Mon–Sat 10 AM–7 PM. 24×7 Emergency. Call +91 93257 69599." },
